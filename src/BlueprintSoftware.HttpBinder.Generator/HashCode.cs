...
{
    private static readonly uint _seed = 0x9E3779B9u; // FNV / golden ratio constant
    ...
    {
        return RotateLeft(hash + input * _prime2, 13) * _prime1;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static uint QueueRound(uint hash, uint queuedValue)
    {
        return RotateLeft(hash + queuedValue * _prime3, 17) * _prime4;
    }
