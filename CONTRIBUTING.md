...
Thanks for helping improve BlueprintSoftware.HttpBinder.
...
```bash
dotnet restore BlueprintSoftware.HttpBinder.slnx
dotnet test --project src/BlueprintSoftware.HttpBinder.Generator.Tests/BlueprintSoftware.HttpBinder.Generator.Tests.csproj --no-restore
```
...
```bash
dotnet pack -c Release src/BlueprintSoftware.HttpBinder.Generator/BlueprintSoftware.HttpBinder.Generator.csproj -o ./nupkgs /p:Version=1.0.0 --no-restore
```
